...
// export const APIKey = 'your_api_key'; // Ensure this is your actual API key from NewsAPI
// export const parseCurrentDate = '2024-06-19'; // Example current date
// export const parsePreviousWeek = '2024-06-12';  // Example date a week prior

// Import Statements and Constants Setup

// export const APIKey = "340dafab05834f4194b546b01ecf4057";

// const currentDate = new Date();

// export const parseCurrentDate = (date = currentDate) => {
...
// export const parsePreviousWeek = `${previousWeek.getFullYear()}-${String(previousWeek.getMonth() + 1).padStart(2, "0")}-${String(previousWeek.getDate()).padStart(2, "0")}`;

// Updated getSearchResults Function with Validation

// import { APIKey, parseCurrentDate, parsePreviousWeek } from "./constants";

// export const getSearchResults = (keyWord) => {
//   if (!keyWord) {
//     return Promise.reject('Error: keyword is required');
//   }
...
//   return fetch(
//     `https://newsapi.org/v2/everything?q=${encodeURIComponent(keyWord)}&from=${parsePreviousWeek}&to=${parseCurrentDate()}&sortBy=popularity&apiKey=${APIKey}`
//   ).then(processServerResponse);
// };

// Test the Function
// Here’s how you might call this function, making sure to pass a valid keyword:
// import { getSearchResults } from './path_to_your_module';

// const keyword = 'technology'; // Replace with the keyword you want to search
